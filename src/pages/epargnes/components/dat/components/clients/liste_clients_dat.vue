        ...
        <div class="col">
          <div class="panel-primary shadow-1 ">
                ...
                <thead>
                  <tr>
                    ...
                    <template v-if="filterListe.type_client =='GROUPE'">
                      <th class="text-center">TYPE DE CONTRIBUTION</th>
                      <th class="text-center">CONTR. CDF</th>
                      <th class="text-center">CONTR. USD</th>
                    </template>
                ...
                <tbody style="font-size:11.5px">
                  ...
                  >
                    ...
                    <template v-if="filterListe.type_client != 'MEMBRE'">
                      ...
                      <td class="text-center">{{$helper.dateBien(row.date_creation,false) || '---'}}</td>
                    </template>
                    ...
                    <template v-if="filterListe.type_client =='GROUPE'">
                      ...
                      <td class="text-center">{{row.montant_cdf}}</td>
                      <td class="text-center">{{row.montant_usd}}</td>
                    </template>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          <q-item-section>DAT effectués par ce membre</q-item-section>
                        </q-item>
            ...
            <myPagination
              ...
              idPagination="paginationMembresDat"
              @onPaginate="getDatas()"
            />
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    getDatas (url = null) {
      ...
      url = url || `${this.URLS.BASE_URL}/Dat/getAllMembresDat`
      ...
      this.$axios
        ...
        .then(infos => {
          ...
          if (infos.data && infos.data.records.length > 0) {
            ...
            let el = document.querySelector('.paginationMembresDat')
            if (el) {
              el.innerHTML = infos.data.pagination
              document.querySelectorAll('.paginationMembresDat a').forEach(el => {
                el.onclick = e => {
                  e.preventDefault()
