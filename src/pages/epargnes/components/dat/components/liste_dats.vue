  ...
  <q-page style="min-height:0">
    <list-menu-options>
      ...
      <menu-option
        text="Nouveau dat"
        icon="add.png"
        @option-clicked="selectedDat=null;isAdd=true;showDlgNouveauDat = true"
      />
              ...
              <table class="table head-bold hover table-striped table-colored-head">
                ...
                <tbody style="font-size:12px">
                  ...
                  >
                    ...
                    <td class="text-center">{{ $helper.dateBien(row.end_date,false) }}</td>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          <q-item-section>Afficher l'opération de transfert du DAT</q-item-section>
                        </q-item>
                        <q-item
                        ...
                        >
                          ...
                          <q-item-section>Afficher l'opération de constitution du DAT</q-item-section>
                        </q-item>
                        <q-item
                          clickable
                          v-ripple
                        ...
                        >
                          ...
                          <q-item-section>Rompre ce DAT</q-item-section>
                        </q-item>
                      </q-list>
                    </q-menu>
                  </tr>
...
<script>
import detailsDat from './details_dat.vue'
import nouveauDossierDat from './nouveau/nouveau_dossier_dat.vue'
...
export default {
  ...
  methods: {
    ...
    getDatas (url = null) {
      ...
      url = url || `${this.URLS.BASE_URL}/Dat/getAllDepotsDat`
    ...
    stopDat (row) {
      this.$q
        .dialog({
          ...
          message: `Souhaitez-vous rompre ce DAT ? <br/> Cette action est irréversible, une fois appliquée, vous ne pouvez plus revenir en arrière. <br/> <b>Continuer quand même ?</b>`,
          cancel: 'Non',
          html: true,
          ok: 'Oui',
          persistent: true
        ...
        .onOk(() => {
          ...
          this.$q.loading.show()
          let url = `${this.URLS.BASE_URL}/Dat/stopDat/`
    ...
    showDetailsEat (row) {
      const donnees = JSON.stringify({
        id_dat_dossier: row.id
      })

      this.$q.loading.show()
      let url = `${this.URLS.BASE_URL}/Dat/getDetailsDat/`
