                ...
                <table class="table ba-outer head-bold hover table-striped table-colored-head ">
                  ...
                  <tbody style="font-size:12px">
                    ...
                    >
                      ...
                      <td class="text-center">{{ $helper.formatMoney(row.interet_mensuel)}} {{devise}}</td>
                    </tr>
                    ...
                    <template>
                      <tr class="panel-primary">
                        ...
                        >TOTAL</td>
                        <td class="text-bold text-center">{{$helper.formatMoney(data.total)}} {{devise}}</td>
                      </tr>
                    </template>
