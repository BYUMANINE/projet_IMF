                ...
                <div class="col-xs-12 col-sm col-md col-lg col-xl">
                  ...
                  >
                    <q-card-section class="row q-pa-sm q-col-gutter-sm">
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        <input-label>Par type adhérent</input-label>
                        <q-select
                          transition-show="scale"
                          transition-hide="scale"
                          square
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        <input-label>Par adhérent</input-label>
                        <q-select
                          transition-show="scale"
                          transition-hide="scale"
                          square
...
export default {
  ...
  data () {
    return {
      ...
      optionsStatus: [
        { value: 'ACTIF', label: 'Uniquement actifs' },
        { value: 'INACTIF', label: 'Uniquement inactifs' }
      ]
    }
  },
  props: {
