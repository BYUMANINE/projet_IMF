    ...
    >
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md col-lg col-xl q-px-sm q-pb-sm">
          <carnetCheques v-if="selectedOption.value === 'SOUSCRIPTION'" />
          <typesCheques v-if="selectedOption.value === 'ENVOI'" />
        </div>
      </div>
    </div>
    <q-drawer
...
import carnetCheques from './components/souscription/liste_souscriptions.vue'
import typesCheques from './components/envoi/liste_envois.vue'
...
export default {
  ...
  computed: {
    titre () {
      ...
      if (this.selectedOption.value === 'SOUSCRIPTION') {
        t = 'SOUSCRIPTION'
      } else if (this.selectedOption.value === 'ENVOI') {
        t = 'ENVOIS SMS'
      }
