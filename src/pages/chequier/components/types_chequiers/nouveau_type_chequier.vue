    ...
    <q-card style="width: 550px; max-width: 95vw;">
      <q-card-section class="q-pa-none ">
        <div class="row panel-primary q-px-md q-py-sm items-center q-gutter-md">
          ...
          <div class="col">
            <div class="text-h6">{{isAdd?'Nouveau ': 'Mise à jours du '}} type</div>
          </div>
          <div
            class="col-auto"
            v-if="isAdd"
                      ...
                      <div class="row q-col-gutter-sm">
                        <div class="col-12">
                          ...
                          <q-input
                            ...
                            dense
                            hide-bottom-space
                            v-model.trim="type_chequier.designation"
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                          ...
                          <q-select
                            ...
                            hide-bottom-space
                            use-input
                            v-model="type_chequier.type_client"
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                          ...
                          <q-input
                            ...
                            dense
                            hide-bottom-space
                            v-model.trim="type_chequier.nb_cheques"
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                          ...
                          <q-select
                            ...
                            hide-bottom-space
                            use-input
                            v-model="type_chequier.devise"
                            :options="['CDF','USD']"
                            :option-value="opt => opt"
                            lazy-rules
                            :rules="[val => !!val || 'Choisissez une devise']"
                            @input="$vue.set(type_chequier,'fk_compte_produit',null)"
                          />
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                          ...
                          <q-input
                            ...
                            dense
                            hide-bottom-space
                            v-model.trim="type_chequier.prix"
                          ...
                          >
                            <template
                              v-if="type_chequier.devise"
                              #append
                            >
                              <strong style="font-size:14px">{{type_chequier.devise}}</strong>
                            </template>
                          </q-input>
                        </div>
                        <div class="col-12">
                          ...
                          <q-select
                            ...
                            emit-value
                            map-options
                            v-model="type_chequier.fk_compte_produit "
                            :options="comptes"
                            :option-value="opt => opt"
                        ...
                        <div
                          class="col-12"
                          v-if="type_chequier.fk_compte_produit"
                        >
                          <input-label>Intitulé du compte</input-label>
                          <div class="text-details"> {{`${type_chequier.fk_compte_produit.indice} - ${type_chequier.fk_compte_produit.intitule}`}}</div>
                        </div>
                      </div>
                    </div>
                  </div>
    ...
    showDialog (newValue, oldValue) {
      if (newValue) {
        if (this.selectedType != null) {
          this.type_chequier = { ...this.selectedType }
        } else {
          this.type_chequier = {}
        }
      }
  ...
  methods: {
    filterComptes (val, update, abort) {
      let donnees = JSON.stringify({
        ...
        devise: this.type_chequier.devise,
        with_length: 14,
        signe_length: '>='
      })
