    ...
    <q-card style="width: 700px; max-width: 95vw;">
      <q-card-section class="q-pa-none ">
        <div class="row panel-primary q-px-md q-py-sm items-center q-gutter-md">
          <div class="col">
            <div class="text-h6">Sélectionner un actionnaire</div>
          </div>
          <div class="col-auto">
            <q-btn
                    ...
                    <table class="table head-bold hover table-striped table-colored-head">
                      ...
                      <tbody style="font-size:11.5px">
                        ...
                        >
                          ...
                          <td class="text-left">{{row.date_naissance || 'Non définie'}}</td>
                          <td class="text-left">{{row.lieu_naissance || 'Non définie'}}</td>
...
export default {
  ...
  methods: {
    ...
    getDatas () {
      ...
      let url = `${this.URLS.BASE_URL}/Actionnaire/searchActionnaires`
