  ...
  <q-page style="min-height:0">
              ...
              <table class="table head-bold hover table-striped table-colored-head">
                <thead>
                  <tr>
                    ...
                    <th class="text-center">TYPE CONTRIBUTION</th>
                    <th class="text-center">CONTRIBUTION CDF</th>
                    <th class="text-left">CONTRIBUTION USD</th>
                    <th class="text-left">DATE CREATION</th>
                  </tr>
                </thead>
                ...
                <tbody style="font-size:11.5px">
                  ...
                  >
                    ...
                    <td class="text-center">{{ row.data.secteur.designation }}</td>
                    <td class="text-center">{{ row.data.type_contribution }}</td>
                    <td class="text-center text-bold">{{ row.data.montant_cdf }}</td>
                    <td class="text-center text-bold">{{ row.data.montant_usd }}</td>
                    <td class="text-center">{{ row.data.created_at }}</td>
    ...
    <search
      ...
      :filters="[
        ...
        { value: `CAST(JSON_EXTRACT(data,'$.type_contribution') AS CHAR)`, label: 'Par type contribution' },
        { value: `CAST(JSON_EXTRACT(data,'$.secteur.designation') AS CHAR)`, label: 'Par secteur d\'activité' }
      ]"
    />
