  ...
  <q-page style="min-height:0">
    ...
    <div class="ba overflow-hidden q-mt-md">
      <table class="table  table-tiny">
        <tr>
          <td class="text-bold text-left bg-blue-1 text-blue relative-position">DISPONIBLE DANS <span class="text-blue">{{_caisseName }}</span>
  ...
  methods: {
    ...
    imprimer (op) {
      ...
      this.$axios({
        ...
        this.document = {
          url,
          name: `BORDEREAU-${op.id_operation}`
        }
