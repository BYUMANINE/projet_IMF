                    ...
                    <div class="ba overflow-hidden panel-primary">
                      ...
                      <div class="q-px-md q-pt-sm q-pb-md">
                        <div class="row q-col-gutter-sm">
                          <div class="col-12">
                            <input-label>Rechercher un compte à créditer</input-label>
                            <q-select
                    ...
                    <div class="ba overflow-hidden panel-primary">
                      ...
                      <div class="q-px-md q-pt-sm q-pb-md">
                        <div class="row q-col-gutter-sm">
                          ...
                          <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            <input-label>Nom complet du déposant</input-label>
                            <q-input
                              square
                              outlined
                              dense
    ...
    _libelle: {
      get () {
        if (this.operation.default_libelle) {
          this.$vue.set(this.operation, 'libelle', `Encaissement de ${this.$helper.formatMoney(this.operation.montant) || '0,00'} ${this.operation.devise || ''} dans le compte ${this.compte ? this.compte.indice : ''} intitulé ${this.compte ? this.compte.intitule : ''}. Déposant : ${this.operation.initiateur || 'Non défini'}`)
        }
  ...
  methods: {
    ...
    saveForm () {
      ...
      this.$q.dialog({
        ...
        const dt = {
          ...this.operation,
          id_compte: this.selectedCompte.id,
          id_agent: this.user.id,
          id_agence: this.user.agence.id,
