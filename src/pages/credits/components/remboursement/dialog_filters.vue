                ...
                <div class="col-xs-12 col-sm col-md col-lg col-xl">
                  ...
                  >
                    <q-card-section class="row q-pa-sm q-col-gutter-sm">
                      ...
                      <div class="col-12">
                        <input-label required>Par remboursement</input-label>
                        <div class="row items-center q-col-gutter-sm">
                          <div class="col">
                            <q-input
                              ...
                              readonly
                              lazy-rules
                              @click="$refs.date_remboursement_min.show()"
                            >
                              <template v-slot:append>
                                ...
                                >
                                  <q-popup-proxy
                                    transition-show="scale"
                                    transition-hide="scale"
                                    ref="date_remboursement_min"
                                  >
                                    <q-date
                                      v-model="filtre.date_remboursement_min"
                                      mask="YYYY-MM-DD"
                                      @input="() => $refs.date_remboursement_min.hide()"
                                    />
                                  </q-popup-proxy>
                                </q-icon>
                              </template>
                          ...
                          <div class="col">
                            <q-input
                              ...
                              mask="####-##-##"
                              readonly
                              @click="$refs.date_remboursement_max.show()"
                            >
                              <template v-slot:append>
                                <q-icon
                                  class="cursor-pointer"
                                ...
                                >
                                  <q-popup-proxy
                                    transition-show="scale"
                                    transition-hide="scale"
                                    ref="date_remboursement_max"
                                  >
                                    <q-date
                                      v-model="filtre.date_remboursement_max"
                                      mask="YYYY-MM-DD"
                                      @input="() => $refs.date_remboursement_max.hide()"
                                    />
                                  </q-popup-proxy>
                                </q-icon>
                              </template>
                      ...
                      <div class="col-12">
                        <input-label required>Par echeance</input-label>
                        <div class="row items-center q-col-gutter-sm">
                          <div class="col">
                            <q-input
                              square
                              ...
                              readonly
                              lazy-rules
                              @click="$refs.date_echeance_min.show()"
                            >
                              <template v-slot:append>
                                <q-icon
                                  class="cursor-pointer"
                                ...
                                >
                                  <q-popup-proxy
                                    transition-show="scale"
                                    transition-hide="scale"
                                    ref="date_echeance_min"
                                  >
                                    <q-date
                                      v-model="filtre.date_echeance_min"
                                      mask="YYYY-MM-DD"
                                      @input="() => $refs.date_echeance_min.hide()"
                                    />
                                  </q-popup-proxy>
                                </q-icon>
                              </template>
                          ...
                          <div class="col">
                            <q-input
                              ...
                              mask="####-##-##"
                              readonly
                              @click="$refs.date_echeance_max.show()"
                            >
                              <template v-slot:append>
                                <q-icon
                                  class="cursor-pointer"
                                ...
                                >
                                  <q-popup-proxy
                                    transition-show="scale"
                                    transition-hide="scale"
                                    ref="date_echeance_max"
                                  >
                                    <q-date
                                      v-model="filtre.date_echeance_max"
                                      mask="YYYY-MM-DD"
                                      @input="() => $refs.date_echeance_max.hide()"
                                    />
                                  </q-popup-proxy>
                                </q-icon>
                              </template>
