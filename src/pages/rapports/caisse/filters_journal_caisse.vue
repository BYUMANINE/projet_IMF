        ...
        <div class="col-xs-12 col-sm col-md col-lg col-xl">
          ...
          >
            <q-card-section class="row q-pa-sm q-col-gutter-sm">
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <input-label>Par caisse </input-label>
                <q-select
                  transition-show="scale"
                  transition-hide="scale"
                  square
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <input-label>Par compte en contre_partie</input-label>
...
export default {
  ...
  beforeMount () {
    ...
    this.filtre.status = this.optionsStatus[0]
    this.filtre.date_min = this.$helper.now('-')
  },
  mounted: function () {
  },
  destroyed: function () {
