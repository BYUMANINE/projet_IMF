        ...
        <div class="col-xs-12 col-sm col-md col-lg col-xl">
          ...
          >
            <q-card-section class="row q-pa-sm q-col-gutter-sm">
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <input-label>Par respect écheance transfert</input-label>
                <q-select
                  transition-show="scale"
                  transition-hide="scale"
                  square
                  ...
                  map-options
                  clearable
                  v-model="filtre.echeance_transfert"
                  :options="['PRET','EN RETARD']"
                  :option-value="opt => opt"
                  :option-label="opt => `${opt}`"
                />
              </div>
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <input-label>Intervalle montant du DAT</input-label>
...
export default {
  ...
  data () {
    return {
      ...
      optionsEcheance: [
        { value: 'PAS ENCORE', label: 'Uniquement les intérêt en retard' },
        { value: 'DEJA', label: 'Uniquement les intérêt deposés' }
      ]
    }
  },
  props: {
