        ...
        <div class="col-xs-12 col-sm col-md col-lg col-xl">
          ...
          >
            <q-card-section class="row q-pa-sm q-col-gutter-sm">
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <input-label>Par décision</input-label>
                <q-select
                  transition-show="scale"
                  transition-hide="scale"
                  square
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                ...
                <q-select
                  ...
                  :options="clients"
                  :option-value="opt => opt"
                  :option-label="opt => !!opt ? `${opt.folio} - ${opt.designation}` : ''"
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <input-label>Intervalle montant demandé</input-label>
                <div class="row items-center q-col-gutter-sm">
                  <div class="col">
                    <q-input
                      ...
                      dense
                      hide-bottom-space
                      v-model="filtre.montant_demande_min"
                  ...
                  <div class="col">
                    <q-input
                      ...
                      dense
                      hide-bottom-space
                      v-model="filtre.montant_demande_max"
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <input-label>Intervalle montant accordé</input-label>
                <div class="row items-center q-col-gutter-sm">
                  <div class="col">
                    <q-input
                      square
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <input-label>Intervalle montant décaissé</input-label>
                <div class="row items-center q-col-gutter-sm">
                  <div class="col">
                    <q-input
                      square
                      ...
                      dense
                      hide-bottom-space
                      v-model="filtre.montant_accorde_min"
                      placeholder="Montant min."
                      lazy-rules
                    >
                      <template v-slot:append>
                  ...
                  <div class="col">
                    <q-input
                      ...
                      dense
                      hide-bottom-space
                      v-model="filtre.montant_accorde_max"
                      placeholder="Montant max."
                      lazy-rules
                    >
                      <template v-slot:append>
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <input-label>Date de demande</input-label>
                <div class="row items-center q-col-gutter-sm">
                  <div class="col">
                    <q-input
                      square
                      ...
                      dense
                      hide-bottom-space
                      v-model="filtre.date_demande_min"
                    ...
                    >
                      <template v-slot:append>
                        <q-btn
                          ...
                          flat
                          round
                          @click="filtre.date_demande_min=null"
                        />
                        <q-icon
                          v-else
                  ...
                  <div class="col">
                    <q-input
                      ...
                      dense
                      hide-bottom-space
                      v-model="filtre.date_demande_max"
                    ...
                    >
                      <template v-slot:append>
                        <q-btn
                          ...
                          flat
                          round
                          @click="filtre.date_demande_max=null"
                        />
                        <q-icon
                          v-else
                          class="cursor-pointer"
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <input-label>Date de ouverture dossier</input-label>
                <div class="row items-center q-col-gutter-sm">
                  <div class="col">
                    <q-input
                      square
                      ...
                      dense
                      hide-bottom-space
                      v-model="filtre.date_creation_min"
                      placeholder="Date min."
                      mask="####-##-##"
                      readonly
                      @click="$refs.popup_dt_ops3.show()"
                    >
                      <template v-slot:append>
                        <q-btn
                          ...
                          flat
                          round
                          @click="filtre.date_creation_min=null"
                        />
                        <q-icon
                          v-else
                          class="cursor-pointer"
                  ...
                  <div class="col">
                    <q-input
                      ...
                      dense
                      hide-bottom-space
                      v-model="filtre.date_creation_max"
                      placeholder="Date max."
                      mask="####-##-##"
                      readonly
                      @click="$refs.popup_dt_ops4.show()"
                    >
                      <template v-slot:append>
                        <q-btn
                          ...
                          flat
                          round
                          @click="filtre.date_creation_max=null"
                        />
                        <q-icon
                          v-else
                          class="cursor-pointer"
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <input-label>Date accordée</input-label>
                <div class="row items-center q-col-gutter-sm">
                  <div class="col">
                    <q-input
                      square
                      ...
                      dense
                      hide-bottom-space
                      v-model="filtre.date_accorde_min"
                      placeholder="Date min."
                      mask="####-##-##"
                      readonly
                      @click="$refs.popup_dt_ops3.show()"
                    >
                      <template v-slot:append>
                        <q-btn
                          ...
                          flat
                          round
                          @click="filtre.date_accorde_min=null"
                        />
                        <q-icon
                          v-else
                          class="cursor-pointer"
                  ...
                  <div class="col">
                    <q-input
                      ...
                      dense
                      hide-bottom-space
                      v-model="filtre.date_accorde_max"
                      placeholder="Date max."
                      mask="####-##-##"
                      readonly
                      @click="$refs.popup_dt_ops4.show()"
                    >
                      <template v-slot:append>
                        <q-btn
                          ...
                          flat
                          round
                          @click="filtre.date_accorde_max=null"
                        />
                        <q-icon
                          v-else
                          class="cursor-pointer"
...
export default {
  ...
  data () {
    return {
      ...
      optionsStatus: [
        { value: 'SUIVI', label: 'Uniquement les dossiers en suivi' },
        { value: 'DECAISSE', label: 'Uniquement les ddossiers décaissés' },
        { value: 'RADIE', label: 'Uniquement les demandes radiées' },
        { value: 'SOLDE', label: 'Uniquement les demandes soldées' }
      ]
    }
  },
  props: {
  ...
  methods: {
    ...
    filterClients (val, update, abort) {
      ...
      let url = `${this.URLS.BASE_URL}/Membre/searchMembresConfondus`
      this.$axios.post(url, this.$helper.objectToform({ 'data': donnees })).then((infos) => {
        update(() => {
