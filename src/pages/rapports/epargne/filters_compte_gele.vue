...
export default {
  ...
  data () {
    return {
      ...
      produits: [],
      optionsTypes: [
        { value: 'S.fk_membre IS NOT NULL', label: 'Uniquement les individus' },
        { value: 'S.fk_groupe IS NOT NULL', label: 'Uniquement les groupes' },
        { value: 'S.fk_entreprise IS NOT NULL', label: 'Uniquement les entreprises' }
      ],
      optionsStatus: [
