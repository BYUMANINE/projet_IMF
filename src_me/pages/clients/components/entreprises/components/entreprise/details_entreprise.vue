      ...
      >
        <q-card-section class="q-pa-none ">
          <div class="row panel-primary q-px-md q-py-sm items-center q-col-gutter-md">
            ...
            <div class="col">
              <div class="text-h6">Détails de l'entreprise [ {{entreprise.folio}} ]</div>
            </div>
            <div class="col-auto">
              <q-btn
                color="blue-1"
          ...
          <div class="row">
            <div class="col">
              ...
              >
                ...
                <q-tab name="3">
                  <strong class="style-tab">ACTIONNAIRES</strong>
                </q-tab>
                <q-tab name="4">
                        ...
                        <div class="q-px-md q-pt-sm q-pb-md">
                          ...
                          <div class="row q-col-gutter-sm">
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                              <input-label>Dénomination</input-label>
                              <div class="text-details">{{entreprise.designation || 'Non défini'}}</div>

                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                              <input-label>Sigle</input-label>
                              <div class="text-details">{{entreprise.sigle || 'Non défini'}}</div>

                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                              <input-label>N° RCCM/Patente</input-label>
                              <div class="text-details">{{entreprise.num_rccm || 'Non défini'}}</div>

                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                              <input-label>Identification Nationale</input-label>
                              <div class="text-details">{{entreprise.id_national || 'Non défini'}}</div>

                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                              <input-label>Forme juridique</input-label>
                              <div class="text-details">{{entreprise.forme_juridique || 'Non défini'}}</div>

                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                              <input-label>Secteur d'activité</input-label>
                              <div class="text-details">{{entreprise.secteur ? entreprise.secteur.designation : 'Non défini' }}</div>

                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                              <input-label>Numéro d'agrement</input-label>
                              <div class="text-details">{{entreprise.num_agrement || 'Non défini'}}</div>

                            </div>

                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                              <input-label>Numéro d'impot</input-label>
                              <div class="text-details">{{entreprise.num_impot || 'Non défini'}}</div>

                            </div>

                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                              <input-label>Employers plein temps</input-label>
                              <div class="text-details">{{entreprise.nb_employe_plein || 'Non défini'}}</div>

                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                              <input-label>Employers temps partiel</input-label>
                              <div class="text-details">{{entreprise.nb_employe_partiel || 'Non défini'}}</div>

                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                              <input-label>Date de création de l'entreprise</input-label>
                              <div class="text-details">{{entreprise.date_creation || 'Non défini'}}</div>

                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                              <input-label>Propriétaire d'autres comptes ailleurs ?</input-label>
                              <div class="text-details">{{entreprise.autres_banques || 'Non défini'}}</div>
                        ...
                        <div class="col-12">
                          <div class="ba overflow-hidden panel-primary">
                            ...
                            <div class="q-px-md q-pt-sm q-pb-md">
                              <div class="row q-col-gutter-sm">
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                  <input-label>Chiffre d'affaire USD</input-label>
                                  <div class="text-details">{{entreprise.ca_usd || 'Non défini'}}</div>

                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                  <input-label>Chiffre d'affaire CDF</input-label>
                                  <div class="text-details">{{entreprise.ca_cdf || 'Non défini'}}</div>

                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                  <input-label>Capital USD</input-label>
                                  <div class="text-details">{{entreprise.capital_usd || 'Non défini'}}</div>

                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                  <input-label>Capital CDF</input-label>
                                  <div class="text-details">{{entreprise.capital_cdf || 'Non défini'}}</div>

                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                  <input-label>Date capital USD</input-label>
                                  <div class="text-details">{{entreprise.date_capital_usd || 'Non défini'}}</div>

                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                  <input-label>Date capital CDF</input-label>
                                  <div class="text-details">{{entreprise.date_capital_cdf || 'Non défini'}}</div>
                            ...
                            <div class="q-mt-none q-px-md q-pb-md">
                              <div class="row q-col-gutter-sm">
                                <div class="col-12">
                                  ...
                                  <div class="text-details">{{entreprise.description || 'Non défini'}}</div>
                        ...
                        <div class="q-px-md q-pt-sm q-pb-md">
                          <div class="row q-col-gutter-sm ">
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                              ...
                              <div class="text-details">{{entreprise.pays || 'Non défini'}}</div>

                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                              <input-label>Province</input-label>
                              <div class="text-details">{{entreprise.province || 'Non défini'}}</div>

                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                              <input-label>Ville </input-label>
                              <div class="text-details">{{entreprise.ville || 'Non défini'}}</div>

                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                              <input-label>Commune/ Territoire</input-label>
                              <div class="text-details">{{entreprise.commune || 'Non défini'}}</div>

                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                              <input-label>Quartier/ Groupement</input-label>
                              <div class="text-details">{{entreprise.quartier || 'Non défini'}}</div>

                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                              <input-label>Avenue/ Village</input-label>
                              <div class="text-details">{{entreprise.avenue || 'Non défini'}}</div>

                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <input-label>N° maison/immeuble</input-label>
                              <div class="text-details">{{entreprise.num_maison || 'Non défini'}}</div>
                        ...
                        <div class="q-px-md q-pt-sm q-pb-md">
                          <div class="row q-col-gutter-sm">
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                              ...
                              <div class="text-details">{{entreprise.phone1 || 'Non défini'}}</div>

                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                              <input-label>Téléphone 2</input-label>
                              <div class="text-details">{{entreprise.phone2 || 'Non défini'}}</div>

                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                              <input-label>Téléphone 3</input-label>
                              <div class="text-details">{{entreprise.phone3 || 'Non défini'}}</div>

                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                              <input-label>Adresse mail</input-label>
                              <div class="text-details">{{entreprise.email || 'Non défini'}}</div>

                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <input-label>Facebook</input-label>
                              <div class="text-details">{{entreprise.facebook || 'Non défini'}}</div>

                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <input-label>Twitter</input-label>
                              <div class="text-details">{{entreprise.twitter || 'Non défini'}}</div>
                    ...
                    >
                      <table class="table ba-outer head-bold hover table-striped table-colored-head ">
                        ...
                        <tbody style="font-size:12px">
                          <tr
                            v-for="(row, index) in entreprise.actionnaires"
                            :key="index"
                  ...
                  <div class="ba overflow-hidden panel-primary">
                    ...
                    >
                      <table class="table ba-outer head-bold hover table-striped table-colored-head">
                        ...
                        <tbody style="font-size:12px">
                          <template v-for="(row0,key0,index0) in entreprise.comptes_grp">
                            <tr :key="'cmpt0'+index0">
                              <td
                                colspan="10"
                  ...
                  <div class="ba overflow-hidden panel-primary">
                    ...
                    >
                      <table class="table ba-outer head-bold hover table-striped table-colored-head ">
                        ...
                        <tbody style="font-size:12px">
                          <tr
                            v-for="(row, index) in entreprise.credits"
                            :key="index"
                          ...
                          <template v-if="!entreprise.credits || entreprise.credits.length === 0">
...
<script>
import detailsActionnaire from '../actionnaire/details_actionnaire.vue'
