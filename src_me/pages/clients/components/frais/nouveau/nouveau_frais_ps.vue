      ...
      <q-card style="width: 700px; max-width: 95vw;">
        <q-card-section class="q-pa-none ">
          <div class="row panel-primary q-px-md q-py-sm items-center q-gutter-md">
            ...
            <div class="col">
              <div class="text-h6">Achat part sociale</div>
            </div>
                        ...
                        <div class="row q-col-gutter-sm">
                          <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            ...
                            <q-select
                              ...
                              @input="$vue.set(frais,'client',null);$vue.set(frais,'compte',null);$vue.set(frais,'compte_part',null)"
                            />
                          </div>
                          <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                          ...
                          <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            ...
                            <q-select
                              ...
                              lazy-rules
                              :rules="[ val => !!val || 'Sélectionner une option']"
                              @input="$vue.set(frais,'compte_part',null)"
                            >
                              <template #no-option>
                                <q-item>
                                  <q-item-section class="text-red">
                          ...
                          <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            <input-label required>Part sociale </input-label>
                            <q-select
                              ...
                              emit-value
                              map-options
                              v-model="frais.compte_part"
                              :options="comptesPartSociale"
                              :option-value="opt => opt"
                          ...
                          <div class="col-12">
                            <div class="row q-col-gutter-sm">
                              <div class="col">
                                <input-label required>Nombre part</input-label>
                                <q-input
                                  square
                                  outlined
                                  dense
                                  hide-bottom-space
                                  v-model="frais.nombre_part"
                                  placeholder="Nombre part"
                                  maxlength="10"
                                  lazy-rules
                                ...
                                >
                                  <template #control>
                                    <div
                                      ...
                                      tabindex="0"
                                    >{{!!frais.compte_part ? frais.compte_part.ps_valeur || '0,00':'0,00'}}</div>
                                  </template>
                                  <template
                                    v-if="!!frais.compte_part"
                                    #append
                                  >
                                    <strong style="font-size:14px">{{frais.compte_part.devise}}</strong>
                                  </template>
                                </q-field>
                              </div>
                              <div class="col">
                                ...
                                >
                                  <template #control>
                                    <div
                                      class="self-center full-width no-outline"
                                      tabindex="0"
                                    >{{$helper.formatMoney(_totalPart)}}</div>
                                  </template>
                                  <template
                                    v-if="!!frais.compte_part"
                                    #append
...
export default {
  ...
  computed: {
    ...
    _totalPart () {
      return this.frais.compte_part
        ? this.$helper.toDouble(this.frais.nombre_part) * this.$helper.toDouble(this.frais.compte_part.ps_valeur)
        : 0
    }
  },
  methods: {
    ...
    searchComptesToPaye (val, update, abort) {
      ...
      this.$axios.post(url, this.$helper.objectToform({ 'data': donnees })).then((infos) => {
        update(() => {
          this.comptesPartSociale = infos.data.records
        })
      }).catch(() => {
        update(() => {
          this.comptesPartSociale = []
        })
      })
    },
    getComptesEpargne (e) {
      ...
      this.$vue.set(this.frais, 'compte_part', null)
      ...
      if (isSucess) {
        this.$q.dialog({
          ...
          let donnees = JSON.stringify({
            type_client: this.frais.type.value,
            id_client: this.frais.client.id_client,
            id_compte_part: this.frais.compte_part.id,
            id_produit: this.frais.compte_part.id_produit,
            id_compte_prelev: this.frais.compte.id,
            id_agent: this.user.id,
            id_agence: this.user.agence.id,
            libelle: this.frais.libelle,
            devise: this.frais.compte.devise,
            nombre_part: this.frais.nombre_part,
            montant: this._totalPart,
            type: 'PS'
          })
