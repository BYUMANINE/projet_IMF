      ...
      <q-card style="width: 700px; max-width: 95vw;">
        <q-card-section class="q-pa-none ">
          <div class="row panel-primary q-px-md q-py-sm items-center q-gutter-md">
            ...
            <div class="col">
              <div class="text-h6">Frais d'ouverture compte</div>
            </div>
                            ...
                            >
                              <template #control>
                                <div
                                  ...
                                  tabindex="0"
                                >{{!!frais.compte_to_paye ? frais.compte_to_paye.eav_frais_ouv_compte || '0,00':'0,00'}}</div>
                              </template>
                              <template
  ...
  methods: {
    ...
    searchComptesToPaye (val, update, abort) {
      let donnees = JSON.stringify({
        ...
        type_operation: 'OUV',
        type_produit: 'EAV',
        exclude_if_has_paye_ouverture: 'OUI'
      })
    ...
    onSubmit (isSucess) {
      if (isSucess) {
        this.$q.dialog({
          ...
          let donnees = JSON.stringify({
            type_client: this.frais.type.value,
            montant: this.frais.compte_to_paye.eav_frais_ouv_compte,
            id_client: this.frais.client.id_client,
