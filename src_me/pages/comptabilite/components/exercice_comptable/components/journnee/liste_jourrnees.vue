<template>
  <q-page style="min-height:0">
    ...
    <list-menu-options>
      ...
      <menu-option
        text="Ouverture journée"
        icon="open.png"
        @option-clicked="ouvertureJournee()"
      />
        ...
        <div class="col">
          <div class="panel-primary shadow-1 ">
              ...
              <table class="table head-bold hover  table-colored-head table-striped">
                <thead>
                  <tr>
                    ...
                    <th class="text-left">DATE JOUR</th>
                ...
                <tbody style="font-size:12px">
                  ...
                  >
                    ...
                    <td class="text-left">{{$helper.long_mois(parseInt(row.mois),true)}}</td>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          <q-item-section>Clôturer la journée ?</q-item-section>
                        </q-item>
                      </q-list>
                    </q-menu>
            ...
            <myPagination
              ...
              idPagination="paginationJournee"
              @onPaginate="getDatas()"
            />
          </div>
        </div>
  ...
  methods: {
    ...
    getDatas (url = null) {
      if (this.$helper.isNotEmpty(this.filterListe.peer_page)) {
        ...
        url = url || `${this.URLS.BASE_URL}/Exercice/getAllJournees`
        ...
        this.$axios.post(url, this.$helper.objectToform({ 'data': donnees })).then((infos) => {
          ...
          if (infos.data && infos.data.records.length > 0) {
            ...
            let el = document.querySelector('.paginationJournee')

            if (el) {
              el.innerHTML = infos.data.pagination
              document.querySelectorAll('.paginationJournee a').forEach(el => {
                el.onclick = e => {
                  e.preventDefault()
    ...
    ouvertureJournee () {
      this.$q.dialog({
        ...
        message: `Souhaitez-vous vraiment ouvrir une nouvelle journée ?`,
        cancel: 'Non',
        ok: 'Oui',
        persistent: true
      }).onOk(() => {
        ...
        this.$q.loading.show()
        let url = `${this.URLS.BASE_URL}/Exercice/ouvertureJournee/`
    ...
    clotureJournee (row) {
      this.$q.dialog({
        dark: this.$q.dark.isActive,
        title: 'Clôture journée en cours...',
        message: `Souhaitez-vous vraiment cloturer cette journée ?`,
        cancel: 'Non',
        ok: 'Oui',
        persistent: true
      }).onOk(() => {
        ...
        this.$q.loading.show()
        let url = `${this.URLS.BASE_URL}/Exercice/clotureJournee/`
