                      ...
                      <div class="ba overflow-hidden panel-primary">
                        ...
                        <div class="q-px-md q-pt-sm q-pb-md">
                          <div class="row q-col-gutter-sm">
                            ...
                            <div class="col-12">
                              <input-label required>Compte epargne</input-label>
                              <q-select
                                :readonly="!(!!groupe)"
                                transition-show="scale"
                                transition-hide="scale"
                      ...
                      <div class="ba overflow-hidden panel-primary">
                        <div class="row items-center">
                          ...
                          <div class="col-auto q-px-md">
                            ...
                            >{{$helper.formatMoney(_montantDepot) }} {{operation.devise}}</span>
                          </div>
                        </div>
                        <q-separator />
                        <div class="q-px-md q-pt-sm q-pb-md">
                        ...
                        >
                          ...
                          <td class="text-center text-bold input-table">
                            <q-input
                              ...
                              lazy-rules
                              :rules="[ val => !val || !!val || 'Champs requis',
                            val => !val || $helper.isNumeric(val) || 'Uniquement les chiffres',
                            val => !val || parseFloat(val) >= 0 || 'Le montant doit être superieur ou égal à zéro',
                            val => !val || _montantReparti >= 0 || 'Montant superieur au reste à répartir']"
                              maxlength="7"
                            >
                              <template
                                v-if="!!operation.devise"
                        ...
                        <tr>
                          ...
                          <td class="text-center input-table">
                            <q-field
                              ...
                              hide-bottom-space
                              lazy-rules
                              :rules="[ val => _montantReparti <= 0 || `Vous devez répartir le ${_montantReparti} ${this.operation.devise} restant aux membres`]"
                            >
                              <template v-slot:control>
                                <div class="self-center full-width no-outline q-pa-none text-bold">
                                  {{_montantReparti}} / {{operation.montant}} {{operation.devise}}
                                </div>
                              </template>
                            </q-field>
                          </td>
                          ...
                          <tr class="panel-primary">
                            ...
                            >
                              <nondata
                                ...
                                @actualiser="getSoldeCompteEpargne(this.groupe)"
                              />
                            </td>
                          </tr>
                        </template>
...
export default {
  ...
  computed: {
    ...
    _libelle: {
      get () {
        if (this.operation.default_libelle) {
          this.$vue.set(this.operation, 'libelle', `Dépôt de ${this.$helper.formatMoney(this._montantDepot) || '0,00'} ${this.operation.devise || ''} dans le compte ${this.compte ? this.compte.indice : ''} du groupe ${this.groupe ? this.groupe.designation : ''}. Déposant : ${this.operation.initiateur || 'Non défini'}`)
        }
    ...
    _montantDepot () {
      return this.$helper.toDouble(this.operation.montant)
    },
    _montantReparti () {
