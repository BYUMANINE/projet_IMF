                    ...
                    <div class="ba overflow-hidden panel-primary">
                      ...
                      <div class="q-px-md q-pt-sm q-pb-md">
                        <div class="row q-col-gutter-sm">
                          <div class="col-12">
                            <input-label>Rechercher une entreprise</input-label>
                            <q-select
                          ...
                          <div class="col-12">
                            ...
                            >
                              <template #control>
                                <div tabindex="0">{{!!compte ? compte.indice || 'Non défini':'Non défini'}}</div>
                              </template>
                            </q-field>
                          </div>
                          ...
                          <div class="col-xs-12 col-sm-12 col-md col-lg col-xl">
                            <input-label>Responsable (gérant)</input-label>
                            <q-field
                              square
                              outlined
                              dense
                            ...
                            >
                              <template v-slot:control>
                                <div
                                  class="self-center full-width no-outline"
                                  tabindex="0"
                                >{{!!entreprise ? entreprise.responsable_str || 'Non défini':'Non défini' }}</div>
                              </template>
                            </q-field>
                          </div>
    ...
    _libelle: {
      get () {
        if (this.operation.default_libelle) {
          this.$vue.set(this.operation, 'libelle', `Dépôt de ${this.$helper.formatMoney(this.operation.montant) || '0,00'} ${this.operation.devise || ''} dans le compte ${this.compte ? this.compte.indice : ''} de l'entreprise ${this.entreprise ? this.entreprise.designation : ''}. Déposant : ${this.operation.initiateur || 'Non défini'}`)
        }
