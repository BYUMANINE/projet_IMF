  ...
  <q-page style="min-height:0">
    <list-menu-options>
      ...
      <menu-option
        ...
        @option-clicked="selectedDat=null;isAdd=true;showDlgCalculInteret = true"
      />
        ...
        <div class="col">
          <div class="panel-primary shadow-1 ">
              ...
              <table class="table head-bold hover table-striped table-colored-head">
                ...
                <tbody style="font-size:12px">
                  ...
                  >
                    ...
                    <td class="text-center">{{row.fk_operation_transfert}}</td>
            ...
            <myPagination
              ...
              idPagination="paginationInteretDat"
              @onPaginate="getDatas()"
            />
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    getDatas (url = null) {
      ...
      url = url || `${this.URLS.BASE_URL}/Dat/getAllInteretsDat`
      ...
      this.$axios
        ...
        .then(infos => {
          ...
          if (infos.data && infos.data.records.length > 0) {
            ...
            let el = document.querySelector('.paginationInteretDat')

            if (el) {
              el.innerHTML = infos.data.pagination
              document.querySelectorAll('.paginationInteretDat a').forEach(el => {
                el.onclick = e => {
                  e.preventDefault()
    ...
    annulerInteret (row) {
      this.$q
        ...
        .onOk(() => {
          ...
          this.$q.loading.show()
          let url = `${this.URLS.BASE_URL}/Dat/annulerInteret/`
