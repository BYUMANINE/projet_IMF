              ...
              >
                ...
                >
                  <div class="row q-col-gutter-md ">
                    <!-- ******************************************* -->
                    <!-- ******************************************* -->
                    <!-- ***** INFORMATIONS SUR LE BLOCAGE DAT ***** -->
                    <!-- ******************************************* -->
                    <!-- ******************************************* -->
                          ...
                          <div class="col">
                            <div class="row items-center">
                              <div class="col">
                                ...
                                >INFORMATIONS DAT <span class="text-primary">[{{dat.code}}]</span></div>
                              </div>
                              <div
                        ...
                        <div class="q-px-md q-pt-sm q-pb-md">
                          <div class="row q-col-gutter-sm">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                              <input-label>Montant DAT</input-label>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                              <input-label>Mode de paiement intérêt</input-label>
                              <div class="text-details"> {{dat.beneficier_interet}}</div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                              ...
                              <div class="text-details"> {{$helper.dateBien(dat.created_at,false)}}</div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                              <input-label>Date fin</input-label>
                              <div class="text-details"> {{$helper.dateBien(dat.end_date,false)}} </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                              <input-label>Compte DAT</input-label>
                              <div class="text-details"> {{dat.indice_compte_dat}}</div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                              <input-label>Référence constitution DAT</input-label>
                              <div
                                class="text-details"
                                @dblclick="showDetailsOperation({id_operation:dat.fk_operation_constitution })"
                              > <span class="text-bold text-primary">{{dat.fk_operation_constitution  || 'N/A'}}</span> </div>
                              <q-tooltip>
                                Cliquer pour afficher les détails sur l'opération
                              </q-tooltip>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                              <input-label>Référence transfert DAT</input-label>
                              <div
                                class="text-details"
                      ...
                      <table class="table ba-outer head-bold hover table-striped table-colored-head ">
                        <thead>
                          <tr>
                            ...
                            <th class="text-center">INTERET MENSUEL</th>
                            <th class="text-center">INTERET TRANSFERE</th>
                        ...
                        <tbody style="font-size:12px">
                          ...
                          >
                            ...
                            <td class="text-center">{{ row.interet_mensuel }} {{dat.devise}}</td>
                            <td class="text-center">{{ row.interet_transfert }} {{dat.devise}}</td>
                            <td class="text-center">
                              <q-icon
                                :color="row.fk_operation_transfert != null ? 'primary':'red'"
                                :name="row.fk_operation_transfert != null ? 'las la-check':'las la-times'"
                                size="16px"
                                class="q-mr-sm"
                              />
                              <strong :class="row.fk_operation_transfert != null ? 'text-primary':'text-red'">{{row.fk_operation_transfert ? 'Accordé' : 'Non accordé'}}</strong>
                            </td>
                            ...
                            >
                              ...
                              >
                                <q-item
                                  ...
                                  v-ripple
                                  v-close-popup
                                  @click="showDetailsOperation({id_operation:row.fk_operation_transfert})"
                                >
                          ...
                          <template>
                            <tr class="panel-primary">
                              ...
                              >TOTAL</td>
                              <td class="text-bold text-center">{{dat.interet}} {{dat.devise}}</td>
                              <td
                                colspan="2"
                                :style="$helper.cellEmptyImg"
                              ></td>
