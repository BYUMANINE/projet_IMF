                    ...
                    <div class="row q-col-gutter-sm items-center q-py-xs q-px-sm">
                      ...
                      <div class="col-auto">
                        <q-btn
                          color="blue-1"
                          text-color="primary"
                          label="Affecter à une agence"
                          icon-right="add"
                          rounded
                          no-caps
                          size="12px"
                          unelevated
                          @click="selectedLigne ={agent: utilisateur,affectation: null}; isAdd=true;showDlgAffectation=true"
                        />
                      </div>
                    </div>
                    <q-separator />
                      ...
                      <table class="table ba-outer head-bold hover table-striped table-colored-head ">
                        <thead>
                          <tr>
                            ...
                            <th class="text-center">HEURES CONNEXION</th>
                            <th></th>
                          </tr>
                        </thead>
                        ...
                        >
                          ...
                          >
                            ...
                            <td class="text-center">{{ row.heure_debut ? `${row.heure_debut} - ${row.heure_fin}` : 'Non définies' }}</td>
                            <td class="text-center">
                              <q-btn
                                color="white"
                                text-color="black"
                            ...
                            >
                              ...
                              >
                                <q-item
                                  ...
                                  v-ripple
                                  v-close-popup
                                  @click="selectedLigne ={affectation: row, agent: utilisateur}; isAdd=false;showDlgAffectation=true"
                                >
