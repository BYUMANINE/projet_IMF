...
export default {
  ...
  data () {
    return {
      ...
      produits: [],
      optionsTypes: [
        { value: 'rel_compte_client.fk_membre IS NOT NULL', label: 'Uniquement les individus', table: 'MEMBRE' },
        { value: 'rel_compte_client.fk_groupe IS NOT NULL', label: 'Uniquement les groupes', table: 'GROUPE' },
        { value: 'rel_compte_client.fk_entreprise IS NOT NULL', label: 'Uniquement les entreprises', table: 'ENTREPRISE' }
      ],
      optionsTypeProduits: [
        { value: 'EAV', label: 'Uniquement les épargnes à vue' },
        { value: 'EAC', label: 'Uniquement les épargnes à lq carte' },
        { value: 'DAT', label: 'Uniquement les dépôt à terme' },
        { value: 'DARS', label: 'Uniquement les DARS' },
        { value: 'EG', label: 'Uniquement les épargnes garantis' }
      ]
    }
  },
  props: {
  ...
  methods: {
    ...
    filterProduits (val, update, abort) {
      let type = this.filtre.typeProduit ? this.filtre.typeProduit.value : null
