...
export default {
  ...
  data () {
    return {
      ...
      produits: [],
      optionsTypes: [
        { value: 'rel_compte_client.fk_membre IS NOT NULL', label: 'Uniquement les individus' },
        { value: 'rel_compte_client.fk_groupe IS NOT NULL', label: 'Uniquement les groupes' },
        { value: 'rel_compte_client.fk_entreprise IS NOT NULL', label: 'Uniquement les entreprises' }
      ],
      optionsStatus: [
        { value: 'ACTIF', label: 'Uniquement les comptes actifs' },
        { value: 'INACTIF', label: 'Uniquement les comptes inactifs' }
      ]
    }
  },
  props: {
