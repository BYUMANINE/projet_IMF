        ...
        <div class="col-xs-12 col-sm col-md col-lg col-xl">
          ...
          >
            <q-card-section class="row q-pa-sm q-col-gutter-sm">
              ...
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <input-label>Par date dépot</input-label>
                <div class="row items-center q-col-gutter-sm">
                  <div class="col">
                    <q-input
                      square
                    ...
                    >
                      <template v-slot:append>
                        <q-btn
                          ...
                          flat
                          round
                          @click="filtre.date_depot_min=null"
                        />
                        <q-icon
                          v-else
                    ...
                    >
                      <template v-slot:append>
                        <q-btn
                          ...
                          flat
                          round
                          @click="filtre.date_depot_max=null"
                        />
                        <q-icon
                          v-else
                          class="cursor-pointer"
...
export default {
  ...
  data () {
    return {
      ...
      optionsType: [
        { value: 'COLLECTEUR', label: 'Uniquement pour les collecteurs' },
        { value: 'INSTITUTION', label: 'Uniquement pours l\'institution' }
      ]
    }
  },
  props: {
