      ...
      >
        <q-card-section class="q-pa-none ">
          ...
          >
            ...
            <filtresAdherants
              v-model="filtre"
              v-if="selectedImprimable.value=='LISTE_ADHERANTS'"
            />
            <filtreJournal
              v-model="filtre"
              v-if="selectedImprimable.value=='JOURNAL'"
            />
            <filtersGrandLivre
              v-model="filtre"
              v-if="selectedImprimable.value=='GRAND_LIVRE'"
            />
            <filterBalanceGenerale
              v-model="filtre"
              v-if="selectedImprimable.value=='BALANCE_GENERALE'"
            />

            <filtersJournalCaisse
              v-model="filtre"
              v-if="selectedImprimable.value=='JOURNAL_CAISSE'"
            />
            <filtersTransfertCaisse
              v-model="filtre"
              v-if="selectedImprimable.value=='TRANSFERT_CAISSE'"
            />
            <filterCompteGele
              v-model="filtre"
              v-if="selectedImprimable.value=='COMPTE_GELE'"
            />
            <filtersReleveCompte
              v-model="filtre"
              v-if="selectedImprimable.value=='RELEVE_COMPTE_EPARGNE'"
            />
            <filtersEncoursEpargne
              v-model="filtre"
              v-if="selectedImprimable.value=='ENCOURS_EPARGNE'"
            />
            <filtersConcentrationEpargne
              v-model="filtre"
              v-if="selectedImprimable.value=='CONCENTRATION_EPARGNE'"
            />

            <filtersDarsListe
              v-model="filtre"
              v-if="selectedImprimable.value=='LISTE_DARS'"
            />
            <filtersEcheancesRateesDars
              v-model="filtre"
              v-if="selectedImprimable.value=='ECHEANCES_RATEES_DARS'"
            />
            <filterDatListe
              v-model="filtre"
              v-if="selectedImprimable.value=='LISTE_DAT'"
            />
            <filterInteretDat
              v-model="filtre"
              v-if="selectedImprimable.value=='INTERET_DAT'"
            />
            <filterCarnetListe
              v-model="filtre"
              v-if="selectedImprimable.value=='LISTE_CARNET'"
            />
            <filterMembreEac
              v-model="filtre"
              v-if="selectedImprimable.value=='LISTE_MEMBRE_EAC'"
            />
            <filterCollecteurListe
              v-model="filtre"
              v-if="selectedImprimable.value=='LISTE_COLLECTEUR'"
            />
            <filterCommissionEac
              v-model="filtre"
              v-if="selectedImprimable.value=='LISTE_COMMISSION_EAC'"
            />
            <filterEcheancesRateesEac
              v-model="filtre"
              v-if="selectedImprimable.value=='ECHEANCE_RATEES_EAC'"
            />
            <filtrePlanningEcheanceEac
              v-model="filtre"
              v-if="selectedImprimable.value=='ECHEANCE_PLANING_EAC'"
            />
            <filtreDepotEac
              v-model="filtre"
              v-if="selectedImprimable.value=='DEPOT_EAC'"
            />
            <filterListeDemandesCredit
              v-model="filtre"
              v-if="selectedImprimable.value=='LISTE_DEMANDE_CREDIT'"
            />
            <filterListeSuiviCredit
              v-model="filtre"
              v-if="selectedImprimable.value=='LISTE_SUIVI_CREDITS'"
            />
            <filterBalanceAgee
              v-model="filtre"
              v-if="selectedImprimable.value=='BALANCE_AGEE'"
            />

            <filterListeRemboursementCredit
              v-model="filtre"
              v-if="selectedImprimable.value=='LISTE_REMBOURSEMENT_CREDITS'"
            />
            <filterPlanningRemboursement
              v-model="filtre"
              v-if="selectedImprimable.value=='PLANNING_REMBOURSEMENT'"
            />

            <filterListeChequiers
              v-model="filtre"
              v-if="selectedImprimable.value=='CHEQUIER'"
            />
          </q-form>
        </q-card-section>
      </q-card>
...
import previewRapportDialog from './preview_rapport_dialog.vue'
...
import filtreDepotEac from './eac/filters_depot_eac.vue'
