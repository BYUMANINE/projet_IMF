      ...
      <q-card style="width: 900px; max-width: 95vw;">
        <q-card-section class="q-pa-none ">
          <div class="row panel-primary q-px-md q-py-sm items-center q-gutter-md">
            <div class="col">
              <div class="text-h6">Recouvrement prêt radié</div>
            </div>
                    ...
                    <div class="ba overflow-hidden panel-primary">
                      ...
                      <div class="q-pa-md">
                        <div class="row q-col-gutter-sm">
                          <div class="col-12">
                            <input-label required>Dossier de crédit radié</input-label>
                            <q-select
                              ...
                              outlined
                              dense
                              placeholder="Sélectionner un dossier de crédit radié"
                              fill-input
                              hide-selected
                              hide-bottom-space
                              use-input
                          ...
                          <div class="col-12">
                            ...
                            >
                              <q-card-section class="q-pa-none q-px-sm text-bold">
                                EPARGNE : {{remboursement ? remboursement.solde_epargne : '0,00'}} {{selectedDossier?selectedDossier.devise :''}}
                              </q-card-section>
                            </q-card>
                          </div>
                          <div class="col-12">
                            ...
                            <div style="border:1px solid rgba(0,0,255,.3);">
                              ...
                              <div class="q-pa-sm">
                                ...
                                >
                                  <q-card-section class="q-pa-none">
                                    <q-checkbox
                                      :disable="!$helper.isNotEmpty(selectedDossier)"
                                      v-model="modifierPenalites"
                                      label="Modifier les penalités"
                                    />
                                  </q-card-section>
                                </q-card>
                                <div>
                                  <input-label>Montant pénalités</input-label>
                                  <q-input
                                    :disable="!modifierPenalites"
                                    square
                                    outlined
                                    dense
                                    hide-bottom-space
                                    v-model="penaliteReparti"
                                    placeholder="Montant en penalité"
                                    lazy-rules
                                    :rules="[ val => val && val.trim().length > 0 || 'Champs requis',
                                              val => this.$helper.isNumeric(val) || 'Uniquement les chiffres',
  ...
  methods: {
    ...
    saveForm (isOk) {
      ...
      this.$q.dialog({
        ...
        message: `Souhaitez-vous vraiment enregistrer ce remboursement ?`,
        cancel: 'Annuler',
        ok: 'Oui',
        persistent: true
      }).onOk(() => {
        let donnees = JSON.stringify({
          ...
          montant_reparti: this.montantReparti,
          capital_remb: this.capitalRemb,
          interet_remb: this.interetRemb,
          penalite_remb: this.penaliteRemb,
          impaye_capital: this.remboursement.impaye_capital,
          encours_capital: this.remboursement.encours_capital,
        ...
        let url = `${this.URLS.BASE_URL}/Remboursement/addRemboursementManuel`
